...
public class BankPaymentSummaryJasperBranchReportTemplate extends
		ReportTemplate {

	private static final Logger logger = LoggerFactory.getLogger(BankPaymentSummaryJasperBranchReportTemplate.class);

	private static PlatformReportType myReportType = PlatformReportType.PROOFS;

	public BankPaymentSummaryJasperBranchReportTemplate() {
