...
public class BankPaymentLateCheckBranchReportTemplate extends ReportTemplate {
	
	private static final Logger logger = LoggerFactory.getLogger(BankPaymentLateCheckBranchReportTemplate.class);

	private static PlatformReportType myReportType = PlatformReportType.DEFERREDPAYMENTS;
	
	public BankPaymentLateCheckBranchReportTemplate() {
	...
	public String toString() {
		return "BankPaymentLateCheckBranchReportTemplate []";
	}
